...
import com.aerofisc.repository.ScheduledReportRepository;
...
public class ReportService {
    ...
    private void appendHeader(StringBuilder report, String title) {
        report.append("===========================================\n");
        report.append("Aerofisc FINANCIAL REPORT\n");
    ...
    private void appendFooter(StringBuilder report) {
        report.append("-------------------------------------------\n");
        report.append("Report generated by Aerofisc\n");
        report.append("Â© 2025 Budget Wise - Smart Finance Management\n");
        report.append("===========================================\n");
    }
